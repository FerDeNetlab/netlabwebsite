...
// ── page.tsx (sin cambios de lógica, solo wrapper limpio) ─────────────────────
writeFileSync(join(root, 'app/admin/pendientes/page.tsx'), `'use client'
...
// ── PendientesClient.tsx ──────────────────────────────────────────────────────
writeFileSync(join(root, 'app/admin/pendientes/PendientesClient.tsx'), `'use client'
...
`, 'utf8')
console.log('ok PendientesClient.tsx')
