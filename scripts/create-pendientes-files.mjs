...
export async function POST(req: Request) {
  ...
  // Si no tiene hora, usar 16:00 UTC (10am CDMX)
  ...
  const result = await sendEmail({
    ...
    html: \`<div style="font-family:monospace;background:#0a0a0a;color:#f5f5f5;padding:24px;border-radius:12px;">
...
// ─── 3. /pendientesfer/page.tsx ─────────────────────────────────────────────
write('app/pendientesfer/page.tsx', `'use client'
...
// ─── 4. admin/pendientes/PendientesClient.tsx ────────────────────────────────
write('app/admin/pendientes/PendientesClient.tsx', `'use client'
